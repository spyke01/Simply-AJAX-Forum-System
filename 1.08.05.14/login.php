...
//========================================
	...
	if (isset($_SESSION['username'])) {
		...
		$page_content = "
			<form action=\"$menuvar[LOGIN]\" method=\"post\" id=\"loginForm\" target=\"_top\">
				<table border=\"0\" Cellpadding=\"0\" cellspacing=\"1\" class=\"LForumBorder center\">
					...
					<tr>
						...
						<td width=\"68%\"  class=\"row1\"><input type=\"text\" name=\"username\" class=\"login2 required\" title=\"Enter your username. This is a required field\" size=\"20\" maxlength=\"40\" value=\"\" /></td>
					</tr>
					<tr>
