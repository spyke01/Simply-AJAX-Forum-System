...
<?
	...
	if (isset($_POST[submit])) {
		...
		if ($totalfailure == 0) { 
			echo "\n<br /><h3><span color='green'>Installation Completed successfully!</span></h3><br /><strong><u>Please Delete This File Before Continuing</u></strong>.<br /><br />You can now view your new forum <a href=\"$menuvar[HOME]\">here</a>."; 
		}
		else { 
