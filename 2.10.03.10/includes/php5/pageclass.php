...
class pageClass { 
	...
	function printSidebar($tagId, $tagClass = "") {
		...
		if ($this->templateVars['aOLm_active'] != INACTIVE && $this->templateVars['uOLm_active'] != INACTIVE) {
			...
			if ($this->templateVars['aOLm_active'] == ACTIVE && ($_SESSION['user_level'] == DISTRIBUTOR || $_SESSION['user_level'] == ADMIN)) {
