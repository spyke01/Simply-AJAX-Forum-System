	...
	<body>
		<div id="container">
			<div id="page">
				...
				<div id="header">
					<img src="themes/installer/images/ftsLogo.png" alt="Fast Track Sites" />
				</div>		
				<div id="content">
					<div id="leftCol">
						<ul id="steps">
							...
							<li<? if ($actual_step == 5) { echo " class=\"current\""; } ?>>5. Configure Your System</li>
							<li<? if ($actual_step == 6) { echo " class=\"current\""; } ?>>6. Finish</li>
						</ul>
					</div>
					<div id="rightCol">
