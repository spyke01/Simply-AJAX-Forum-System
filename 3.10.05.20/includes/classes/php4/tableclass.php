...
class tableClass { 
	...
	//===============================================================
	function tableClass($border = 0, $padding = 0, $spacing = 0, $class = "", $id = "") {
		$this->border = $border;
	...
	//===============================================================
	function addNewRow($data, $id = "", $class = "", $section = "tbody") {
		switch ($section) {
			case 'thead':
	...
	//===============================================================
	function returnSectionHTML($sectionArray) {	
	...
	//===============================================================
	function returnTableHTML($theadID = "", $tbodyID = "", $tfootID = "") {
